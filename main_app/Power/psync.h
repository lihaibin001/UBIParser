...
#define PS_OBD_ON_TIME               (PS_Get_Obd_On_Minutes()*60000)// cold start without CAN can awake 5min
...
#define PS_STDBY_TIME_FROM_ENG_ON            (30000) //(300000)/*system will awake for 300s after engine off */
...
#define PS_STDBY_INT_BATT_TIME                  (10000)	//(90000)/*system will awake for 90s when working internal battery case*/
...
#define PS_MIN_AWAKE_TIME              10000
#define PS_IDLE_TIME                   1500

//
#define PS_CHRG_DELAY_TIME             (600000)     //Delay 10 min after engine on
#define PS_CHRG_TIME                   (600000)     //Charge 10 min
