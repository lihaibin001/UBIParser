	...
	if (p_bma2x2 == BMA2x2_NULL) {
		...
		switch (channel_u8) {
          ...
          case BMA2x2_LOW_THRES:
			/*LOW THRESHOLD*/
			data_u8 = thres_u8;
			com_rslt = bma2x2_write_reg(BMA2x2_LOW_THRES_ADDR, &data_u8,
                                        BMA2x2_GEN_READ_WRITE_LENGTH);
            break;
          case BMA2x2_HIGH_THRES:
			/*HIGH THRESHOLD*/
			data_u8 = thres_u8;
			com_rslt = bma2x2_write_reg(BMA2x2_HIGH_THRES_ADDR, &data_u8,
                                        BMA2x2_GEN_READ_WRITE_LENGTH);
            break;
          case BMA2x2_SLOPE_THRES:
			/*SLOPE THRESHOLD*/
			data_u8 = thres_u8;
			com_rslt = bma2x2_write_reg(BMA2x2_SLOPE_THRES_ADDR, &data_u8,
                                        BMA2x2_GEN_READ_WRITE_LENGTH);
            break;
          case BMA2x2_SLOW_NO_MOTION_THRES:
			/*SLO NO MOT THRESHOLD*/
			data_u8 = thres_u8;
			com_rslt = bma2x2_write_reg(BMA2x2_SLOW_NO_MOTION_THRES_ADDR,
                                        &data_u8, BMA2x2_GEN_READ_WRITE_LENGTH);
            break;
          default:
			com_rslt = E_OUT_OF_RANGE;
...
/*!
*	@brief This API is used to set
*	the trigger of fast offset compensation(x/y/z) in the register 0x36
*	bit 5~6
*
*
*
*  @param  cal_trigger_u8: The value of trigger axis
*
*     cal_trigger_u8         |    result
*  ------------------------- |------------------
*         0x00               |    None
*         0x01               |    BMA2x2_OFFSET_TRIGGER_X
*         0x02               |    BMA2x2_OFFSET_TRIGGER_Y
*         0x03               |    BMA2x2_OFFSET_TRIGGER_Z
*   
*	@return results of bus communication function
*	@retval 0 -> Success
*	@retval -1 -> Error
...
*        1                   |   BMA2x2_ACCEL_OFFSET_TRIGGER_X
*        2                   |   BMA2x2_ACCEL_OFFSET_TRIGGER_Y
*        3                   |   BMA2x2_ACCEL_OFFSET_TRIGGER_Z
*
*  @param  offset_u8: The offset target value
*     CUT_OFF                |    result
*  ------------------------- |------------------
...
*
*/
BMA2x2_RETURN_FUNCTION_TYPE bma2x2_read_fifo_data(struct fifo_configuration *fifo_conf)
{
