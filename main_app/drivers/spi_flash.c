...
void sFLASH_Init(void)
{
    ...
    SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_2; // 24/2=12MHz
    ...
    /*!< Send "Release Deep Power-down / Device ID (ABh)  " instruction   */
//    sFLASH_SendByte(0xAB);
}
