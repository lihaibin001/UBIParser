...
extern void Pwr_Charge_Monitor(void); //
extern bool Pwr_Is_Charge_Request(void);
extern bool Pwr_Fail_Is_Int_Battery(void);
extern bool Pwr_Fail_Is_Shutdown(void);
/*===========================================================================*/
