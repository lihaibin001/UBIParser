...
typedef enum wake_up_src_f
{
   ...
   IGN_ON_WAKE_UP       = 0x20,     /* ignition on wake up */
   EXT_BATT_ON_WAKE_UP       = 0x40,     /* ignition on wake up */
} wake_up_src_f_t;
...
typedef union wake_up_src_flags
{
   ...
   struct
   {
      ...
      uint8_t Ignition_WakeUp_f		: 1;  // bit 5
      uint8_t Ext_Batt_On_WakeUp_f	: 1;  // bit 6
      uint8_t reserved				: 1;
   }field;
} wake_up_src_flags_t;
...
{
   LED_OFF				= 0x00,
//   LED_TOGGLE_FAST		= 0x01,   /*toggle @ 160ms*/
...
extern void Sys_Set_Ignition_Wakeup_Flag(void);
extern bool Sys_Is_Ignition_Wakeup(void);
extern void Sys_Clear_Ignition_Wakeup_Flag(void);

extern void Sys_Set_Ext_Batt_On_Wakeup_Flag(void);
extern bool Sys_Is_Ext_Batt_On_Wakeup(void);
extern void Sys_Clear_Ext_Batt_On_Wakeup_Flag(void);

extern void Sys_Set_Int_battery_Flag(void);
extern bool Sys_Get_Int_battery_Flag(void);
extern void Sys_Clear_Int_battery_Flag(void);
