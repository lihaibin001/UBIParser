 ...
 *********************************************************************/
#define TASK_RECORD_QUEUE_SIZE 4
#define TASK_PSYNC_QUEUE_SIZE  4
#define TASK_RELAYS_QUEUE_SIZE  0
#define TASK_PERIODIC_QUEUE_SIZE  0
#define TASK_DIAG_QUEUE_SIZE 8
#define TASK_IOT_QUEUE_SIZE 8
#define TASK_GPS_QUEUE_SIZE 2
#define TASK_SENSOR_QUEUE_SIZE 3
/*********************************************************************
...
#define TASK_IOT_PRIORITY      RTOS_LOW_RIORITY
